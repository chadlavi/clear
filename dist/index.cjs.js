...
var StyledLabel = styled__default(Label$1)(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n  color: ", ";\n  display: flex;\n  flex-direction: column;\n  ", ";\n  width: 100%;\n  & > span {\n    font-size: var(--clear-font-size-label);\n  }\n"], ["\n  color: ", ";\n  display: flex;\n  flex-direction: column;\n  ",
    ";\n  width: 100%;\n  & > span {\n    font-size: var(--clear-font-size-label);\n  }\n"
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
])), function (p) { return p.error ? 'var(--clear-error)' : 'inherit'; }, function (p) { return p.disabled ? "\n    opacity: 0.5;\n  " : ''; });
// eslint-disable-next-line @typescript-eslint/no-unused-vars
...
var Select = function (props) {
    ...
    return (React.createElement(StyledLabel, { className: other.className, disabled: other.disabled, error: other.error, htmlFor: forwardID },
        ...
        React.createElement(StyledSelect, __assign({}, other, { id: forwardID, defaultValue: multiple ? undefined : '', multiple: multiple }),
