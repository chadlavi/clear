 ...
 */
var TableHead = styled('thead')(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["\n  th {\n    font-size: var(--clear-font-size-label);\n    text-align: left;\n    padding: var(--clear-unit);\n    padding-bottom: calc(var(--clear-unit) / 2);\n  }\n"], ["\n  th {\n    font-size: var(--clear-font-size-label);\n    text-align: left;\n    padding: var(--clear-unit);\n    padding-bottom: calc(var(--clear-unit) / 2);\n  }\n"])));
 ...
 */
var TableBody = styled('tbody')(templateObject_1$h || (templateObject_1$h = __makeTemplateObject([""], [""])));
 ...
 */
var TableCell = styled('td')(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  text-align: left;\n  padding: var(--clear-unit);\n"], ["\n  text-align: left;\n  padding: var(--clear-unit);\n"])));
